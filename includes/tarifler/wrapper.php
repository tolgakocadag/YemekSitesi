		...
		<div class="sixteen columns">
			<div id="advanced-search">
				...
				<div class="select included-ingredients">
					<label>Tarifte bulunması gereken bir veya daha fazla içerik seçin</label>
	...
	<div class="clearfix"></div>
		...
		<div class="isotope">
			...
			<?php
				...
				{
					$getSearchDB=getDBSEARCHRAND($_GET['kategori']);
					foreach ($getSearchDB as $key => $value) {
						$searchtitle=$value['recides_TITLE'];
						$searchimage=$value['recides_IMAGE'];
						$searchimage=rtrim($searchimage,",");
						$searchimage=explode(",",$searchimage);
						$searchURL=$value['recides_URL'];
						echo '
						<div class="four isotope-box columns">
							...
							<div class="recipe-box-content">
								<h3><a href="'.$searchURL.'">'.$searchtitle.'</a></h3>
